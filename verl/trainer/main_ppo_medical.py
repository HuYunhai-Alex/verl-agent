...
from verl.trainer.ppo.ray_trainer_medical import RayPPOTrainer
...
class TaskRunner:
    def run(self, config):
        ...
        from verl.trainer.ppo.ray_trainer_medical import ResourcePoolManager, Role

        role_worker_mapping = {
            Role.ActorRollout: ray.remote(actor_rollout_cls),
            Role.SpecialistRollout: ray.remote(actor_rollout_cls),
            Role.InternistRollout: ray.remote(actor_rollout_cls),
        ...
        mapping = {
            ...
            Role.SpecialistRollout: global_pool_id,
            Role.InternistRollout: "internist_pool",
        }
