...
def load_prompts(dataset_path, num_prompts):
    if os.path.exists(dataset_path):
        ...
        prompts = [
            ...
            "The capital of France is", "The largest mammal is",
        ]
...
def main():
    ...
    model_dir = "meta-llama/Llama-3.1-8B-Instruct"  # or "meta-llama/Llama-3.2-1B-Instruct"
    eagle_dir = "meta-llama/Llama-3.2-1B-Instruct"
    ...
    for output in outputs:
        print(output)
        print(f"response length = {len(output.outputs[0].token_ids)}. draft token count: {sum(output.metrics.spec_token_acceptance_counts)}")
        print(output.metrics.spec_token_acceptance_counts)
